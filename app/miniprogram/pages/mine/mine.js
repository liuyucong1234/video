...
Page({
  ...
  onLoad: function (params) {
    ...
    var createrId = params.createrId;
    if (createrId != null && createrId != '' && createrId != undefined) {
      userId = createrId;
      me.setData({
        isMe: false,
        createrId: createrId,
    ...
    // 调用后端
    wx.request({
      url: serverUrl + '/user/find?userId=' + userId + "&fanId=" + user.id,
      method: "POST",
      header: {
  ...
  followMe: function (e) {
    ...
    var url = '';
    if (followType == '1') {
      url = '/user/addFans?userId=' + publisherId + '&fansId=' + userId;
    } else {
      url = '/user/deleteFans?userId=' + publisherId + '&fansId=' + userId;
    }
  ...
  getMyVideoList: function (page) {
    ...
    var serverUrl = app.serverUrl;
    wx.request({
      url: serverUrl + '/video/all/?page=' + page + '&pageSize=6',
      method: "POST",
      data: {
  ...
  getMyLikesList: function (page) {
    ...
    var serverUrl = app.serverUrl;
    wx.request({
      url: serverUrl + '/video/findMyLikeVideos/?userId=' + userId + '&page=' + page + '&pageSize=6',
      method: "POST",
      header: {
        'content-type': 'application/json' // 默认值
      },
  ...
  getMyFollowList: function (page) {
    ...
    var serverUrl = app.serverUrl;
    wx.request({
      url: serverUrl + '/video/findMyFollowVideos/?userId=' + userId + '&page=' + page + '&pageSize=6',
      method: "POST",
      header: {
        'content-type': 'application/json' // 默认值
      },

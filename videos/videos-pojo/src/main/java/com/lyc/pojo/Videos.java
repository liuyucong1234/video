...
2、禁止播放，管理员操作
    ...
    public static class VideoBuilder{
        ...
        public VideoBuilder audioId(String audioId) {
            this.audioId = audioId;
            return this;
        }
        public VideoBuilder videoDesc(String videoDesc) {
            this.videoDesc = videoDesc;
            return this;
        }
        ...
        public VideoBuilder videoSeconds(Float videoSeconds) {
            this.videoSeconds = videoSeconds;
            return this;
        }
        public VideoBuilder coverPath(String coverPath) {
            this.coverPath = coverPath;
            return this;
        }
        public VideoBuilder videoWidth(Integer videoWidth) {
            this.videoWidth = videoWidth;
            return this;
        }
        public VideoBuilder videoHeight(Integer videoHeight) {
            this.videoHeight = videoHeight;
            return this;
        }
        public VideoBuilder likeCounts(Long likeCounts) {
            this.likeCounts = likeCounts;
            return this;
        }
        public VideoBuilder status(Integer status) {
            this.status = status;
            return this;
        }
        public VideoBuilder createTime(Date createTime) {
            this.createTime = createTime;
            return this;
        }

        public Videos build(){
            return new Videos(id,userId,audioId,videoDesc,videoPath,videoSeconds,videoWidth,videoHeight,coverPath,likeCounts,status,createTime);
        }
